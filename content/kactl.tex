...
\university{BINUS}{Universitas Bina Nusantara}{binus}
\team{3UwUs}{Felix Antonius Suharjo, Francis Alexander Panarto, Tyrone Matthew Phanghegar}
\contest{Schematics NPC Final 2023}{Sep 31, 2023}
% \contest{\ }{\today}
% \enablecolors
